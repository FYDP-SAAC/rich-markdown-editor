...
class RichMarkdownEditor extends React.PureComponent {
                ...
                React.createElement(styled_components_1.ThemeProvider, { theme: theme },
                    React.createElement(React.Fragment, null,
                        ...
                        !readOnly && this.view && (React.createElement(React.Fragment, null,
                            ...
                            React.createElement(BlockMenu_1.default, { view: this.view, commands: this.commands, isActive: this.state.blockMenuOpen, search: this.state.blockMenuSearch, onClose: this.handleCloseBlockMenu, uploadImage: this.props.uploadImage, onImageUploadStart: this.props.onImageUploadStart, onImageUploadStop: this.props.onImageUploadStop, onShowToast: this.props.onShowToast, embeds: this.props.embeds })))))));
        };
    }
    componentDidMount() {
        this.init();
    ...
    createState(value) {
        const doc = this.props.jsonStrValue
            ? prosemirror_model_1.Node.fromJSON(this.schema, JSON.parse(value || this.props.defaultValue))
